...
// EntityDef describes a placed entity definition for sprite loading.
...
// LoadEntityDef reads a JSON definition from disk.
...
// LoadEntitySpriteImage loads a sprite image based on a sprite spec.
